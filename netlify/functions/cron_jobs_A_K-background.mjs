...
import { extractBodyExperience, extractTechnologies, INTERNSHIP_KEYWORDS, isInternshipTitle, isSeniorExperience, withTitleTechnologies } from "./_experience_core.mjs";
