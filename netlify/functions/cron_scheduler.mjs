...
const GRID = {
  ...
  // cvonline NINCS itt (2026-09-15): a scraper megépült, de élő smoke-teszt
  // kiderítette, hogy a Netlify Lambda IP-t a cvonline.hu saját JS-es
  // "botchallenge.html" gátja blokkolja (ugyanaz a hibaosztály, mint
  // allasportal-nál, csak Cloudflare helyett saját bot-check) — lásd a
  // scraper file fejlécét és a CRON_SCHEDULE.md alján lévő megjegyzést.
