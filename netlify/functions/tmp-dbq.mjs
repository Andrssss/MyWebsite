/*
  ...
  Created 2026-08-28 to diagnose reported alllocaljobs duplicate rows
  ("AWS Cloud Architect" x6, all inactive).
  Token is hardcoded on purpose: single-use, removed in the same session.
*/
import { Pool } from "pg";

const TOKEN = "dc4292996b6903ea0afd3d7b177b145c4245844607839b7b";
const pool = new Pool({
